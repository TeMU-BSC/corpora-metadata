...
CORPUS_KEYS = ['corpus_path', 'corpus_name', 'domain', 'provider', 'license', 'source', 'languages', 'parallel',
               'aggregated', 'document_level', 'third_parties', 'publishable', 'comments', 'versions']
